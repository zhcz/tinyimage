...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 w-full">
      <div className="container flex h-16 items-center space-x-4 bg-background/80 p-4 backdrop-blur-2xl sm:justify-between sm:space-x-0 md:p-8" style={{ display: 'none' }}>
